...
public class TracingAsyncMongoClient implements MongoClient {
    ...
    public TracingAsyncMongoClient(final MongoClientSettings settings) {
        this(settings, null);
    }

    public TracingAsyncMongoClient(final MongoClientSettings settings, final MongoDriverInformation mongoDriverInformation) {
